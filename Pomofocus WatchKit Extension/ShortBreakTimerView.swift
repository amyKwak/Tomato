...
struct ShortBreakTimerView: View {
    @State var isTimerRunning = false
    @State var to:CGFloat = 0
    @State var timeDuration = 300
            ...
            VStack {
                ...
                Button(action: {
                    ...
                    Text(self.isTimerRunning ? "PAUSE" : "START")
                        .font(.title3)
                        .foregroundColor(Color("ShortBreakBackgroundColor"))
                }
                .frame(height: 40.0)
...
struct ShortBreakTimerView_Previews: PreviewProvider {
